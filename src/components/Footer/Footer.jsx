    ...
    return (
        ...
        ">
              ...
              <div class="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
                ...
                <span class="mt-2 text-sm font-light text-gray-500"> Copyright © 2020 - 2021 <a href="info@Artna.com" class="mx-2 text-wickedblue hover:text-gray-500" rel="noopener noreferrer">info@Artna.com</a>. Since 2020 </span>
              </div>
            </div>
          </footer>
