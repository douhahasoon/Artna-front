...
(props) {
    ...
    const addToCart= ()=> {
    APIJS.post(`/api/order/add-to-cart`, {
        'product_id': props.id,
        'item_qty': count == 0 ? 1 : count
    })
    .then(
        res=>{ 
            setalert(1);
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    ...
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">{props.name}</h2>
                    ...
                    <p className=" font-normal text-base leading-6 text-gray-600 mt-7">{props.description}</p>
                    <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 ">$ {props.price}</p>
                    ...
                    <button onClick={addToCart}  className="focus:outline-none 
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img width={340}  src={(props.image? baseURL+ props.image : '')} alt="Wooden Chair Previw" />
                    </div>
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        {/* <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img  src="./src/Images/DesignPicked/vv.png" alt="Wooden chair - preview 1" />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img  src="./src/Images/DesignPicked/vv.png" alt="Wooden chair - preview 2" />
                        </div> */}
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img  src={(props.image? baseURL+ props.image : '')} alt="Wooden chair- preview 3" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex  justify-center items-center w-full">
                <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
                    <div>
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Product Guarantee</p>
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Smart Design</p>
