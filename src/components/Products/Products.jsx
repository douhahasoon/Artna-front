  ...
  return (
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="/gallery" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Shop now</a>
        </div>
        </Link>
    </div>
</div>
...
<div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-white-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex justify-between items-center">
            ...
            <Link to='/gallery'>
            <a href="/gallery" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 
            font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 
            dark:hover:bg-blue-700 dark:focus:ring-blue-800">Shop now</a>   
            </Link>
                 </div>
    </div>
