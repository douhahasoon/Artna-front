...
<div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-white-800 dark:border-gray-700">
        ...
        <img width={330} class="p-8  rounded-t-lg ml-7" src= {(props.image ? baseURL + props.image : '')} alt="product image" />
        </a>
        ...
        <div class="px-5 pb-5">
            {/* <NavLink to="Gallery">  */}
                ...
                <h3 class="w-5 h-5 text-xl font-semibold tracking-tight text-gray-900 dark:text-black">{props.name}</h3>
                <p className="text-left mt-1 max-w-2xl text-sm text-gray-500">{props.description}</p>
            ...
            <div class="flex justify-between items-center">
                <span class="text-3xl font-bold text-gray-900 dark:text-black">${props.price}</span>
