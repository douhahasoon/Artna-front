    ...
    <div class="grid flex-grow h-full  ">
      ...
      <div class="place-self-center mb-10">
        ...
        <p class="text-xs font-sans text-gray-400">
          ...
          <Link to="/signup">
            <a href="#" class="text-xs font-sans text-gray-600">
              {" "}
              Sign up here
            </a>
          </Link>
      ...
      <div class="form-control  place-self-center">
        <label class="label">
          <span class="label-text  mx-8 text-gray-400">Email Address</span>
        </label>
        <input
          value={email}
          type="text"
        ...
        />
        {errors.email && (
          <small className="text-red-400 ml-9"> {errors.email.message} </small>
        )}
      </div>
      <div class="form-control place-self-center">
        <label class="label">
          <span class="label-text  mx-8 text-gray-400 ">Password</span>
        </label>
        <input
          value={password}
          type="password"
        ...
        />
        {password.email && (
          <small className="text-red-400 ml-9">
            {" "}
      ...
      <button
        type="submit"
        onClick={login}
        class="btn btn-wide  mx-8 place-self-center  "
      >
        Login
      </button>
    </div>
